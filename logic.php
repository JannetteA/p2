...
# Selecting one number and one symbol from teh arrays above
...
If ($n <3 or $n > 5) {
		...
		$newpassword = " ";
		$errormessage = "The total number of words requires a minimum of 3 and a maximum of 5";
}
		...
		#Looping throug array to create a new password
